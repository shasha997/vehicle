...
import static paytm.config.ConfigKeys.*;
...
public enum Config implements PeConfig {
  ...
  private final static String SERVICE_ID= "pe/paytm";

  Config() {
    config = SpConfig.getSpConfig("pe/paytm");

    config.register(HOST, "vehiclelist", "Hostname for the pe sinks");
